...
function App()
{
    ...
    function getData()
    {
        var weather = axios(`https://api.openweathermap.org/data/2.5/weather?q=${enteredvalue}&appid=bef6ced630772f95fffda983a7e7c047`)
    ...
    className="p-2 rounded-md shadow">
            ...
            h-6 text-sm mt-2 p-1 outline-none" 
